...
class OpenAILLM(LLMInterface):
    ...
    async def generate(self, history: List[Dict[str, str]], vault_input: str, simultaneous: bool, target_lang: str, stream_mode: bool, max_lengths: int = 256) -> Tuple[str, List[Dict[str, str]]]:
    ...
    async def generate_response(self, history: List[Dict[str, str]], query: str, simultaneous: bool, target_lang: str, stream:  bool, max_lengths: int = 256) -> Tuple[str, List[Dict[str, str]]]:
