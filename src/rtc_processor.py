...
class BaseProcessor:
    ...
    def put_audio_frame(self, audio_chunk):  # 16khz 20ms pcm, float NumPy
    ...
    def start_recording(self, path):
        ...
        process_thread = threading.Thread(target=self.record_frame, args=())
...
class RTCProcessor(BaseProcessor):
    def __init__(self, opt):
        ...
        self.idx = 0
        self.batch_size = 1
        self.res_frame_queue = Queue(maxsize=self.batch_size * 2)
    ...
    def render(self, quit_event, loop=None, audio_track=None, video_track=None):
        ...
        process_thread = threading.Thread(target=self.process_frames, args=(quit_event, loop, audio_track, video_track))
        process_thread.start()
    ...
    def start_rendering(self):
        ...
        self.process_thread = threading.Thread(target=self.process_frames, args=(self.quit_event, self.loop, self.audio_queue, self.video_queue))
