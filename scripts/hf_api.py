...
if __name__ == "__main__":
    r"""
    python hf_api.py upload_file -rt dataset -r geeek/youtube_videos -f ./videos/Andre/\[1hr\ Talk\]\ Intro\ to\ Large\ Language\ Models.mp4 -p /Andre/\[1hr\ Talk\]\ Intro\ to\ Large\ Language\ Models.mp4
    """
