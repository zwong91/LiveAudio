...
# Start the app
HF_ENDPOINT=https://hf-mirror.com python3 -m src.main --certfile cf.pem --keyfile cf.key --port 8765 --asr-type faster_whisper  --llm-type ollama --tts-type xtts-v2 --vad-type silero
