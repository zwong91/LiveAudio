...
HF_ENDPOINT=https://hf-mirror.com python3 -m src.main --tts-type xtts-v2 --vad-type pyannote --vad-args '{"auth_token": "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"}' --llm-type openai
```
***test***
